...
// Source: ./vendor/github.com/asecurityteam/go-vpcflow/readerdigester.go
...
func (_m *MockDigester) Digest() (io.ReadCloser, error) {
...
func (_mr *_MockDigesterRecorder) Digest() *gomock.Call {
